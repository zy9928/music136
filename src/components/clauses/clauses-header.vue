<template>
  <div class="clauses-header">
    <div class="clauses-header-left">
      <img :src="picture" alt />
    </div>
    <div class="clauses-header-right">
      <div class="zy_tx">
        <p class="type">{{type}}</p>
      ...
      <div class="opa">
        ...
        <ul class="other-opa">
          ...
          <li>
            <a href>
              <span class="iconfont iconcc-comment"></span>
              {{commentText}}
            </a>
          </li>
        </ul>
      ...
      <div class="text">
        <div class="tag" v-show="tags&&tags.length>0">
          <span>标签:</span>
          <li v-for="item in tags" :key="item">
            {{item}}
          </li>
        </div>
        <div class="intr" v-show="desc">
          <p>介绍:&nbsp;{{desc}}</p>
        </div>
      </div>
    </div>
...
.clauses-header {
  ...
  &-right {
    ...
    .type {
      ...
      text-align: center;
      line-height: 24px;
      background: url("../../assets/cc-tag.png") 100% 100%;
      float: left;
      color: #fff;
      font-size: 14px;
    }
